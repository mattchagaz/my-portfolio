...
function switchTheme() {
  ...
  const srcButton = document.body.classList.contains('light-theme')
    ? 'assets/img/moon.svg'
    : 'assets/img/sun.svg'
  document.getElementById('moon').setAttribute('src', srcButton)

  const srcHtml = document.body.classList.contains('light-theme')
    ? 'assets/img/html5.svg'
    : 'assets/img/html5-dark.svg'
  document.getElementById('html').setAttribute('src', srcHtml)

  const srcCss = document.body.classList.contains('light-theme')
    ? 'assets/img/css3.svg'
    : 'assets/img/css3-dark.svg'
  document.getElementById('css').setAttribute('src', srcCss)

  const srcNodejs = document.body.classList.contains('light-theme')
    ? 'assets/img/nodejs.svg'
    : 'assets/img/nodejs-dark.svg'
  document.getElementById('node').setAttribute('src', srcNodejs)

  const srcGit = document.body.classList.contains('light-theme')
    ? 'assets/img/git.svg'
    : 'assets/img/git-dark.svg'
...
const modal = {
  ...
  react: document.querySelector('#reactjs'),
